...
; 
; IF SO, GOTO INSTRUCTION FOR Number3
; 
; IF NOT, CHECK IF COL#4 IS HIGH
; 
; IF SO, GOTO INSTRUCTION FOR letterA
; 
...
; IF NOT, CHECK IF COL#3 IS HIGH
; 
; IF SO, GOTO INSTRUCTION FOR Number6
; 
; IF NOT, CHECK IF COL#4 IS HIGH
; 
; IF SO, GOTO INSTRUCTION FOR letterB
; 
